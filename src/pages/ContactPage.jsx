    ...
    <>
      ...
      <section className="contact-section"><div className="container contact-grid">
        <div className="contact-details">
          <div><span className="contact-icon">@</span><h2>Email</h2><a href="mailto:hello@digitalcreative.vn">hello@digitalcreative.vn</a><p>Phù hợp cho câu hỏi chung và đề xuất hợp tác.</p></div>
          <div><span className="contact-icon">?</span><h2>Hỗ trợ</h2><a href="mailto:support@digitalcreative.vn">support@digitalcreative.vn</a><p>Hỗ trợ tài khoản, dự án và giao dịch trên nền tảng.</p></div>
          <div><span className="contact-icon">↗</span><h2>Thời gian phản hồi</h2><strong>Trong vòng 1–2 ngày làm việc</strong><p>Thứ Hai đến Thứ Sáu, 09:00–18:00 (GMT+7).</p></div>
        </div>
        <form className="contact-form" onSubmit={submit} noValidate>
          ...
          <button className="button button-primary submit-button" type="submit">Gửi lời nhắn <span aria-hidden="true">↗</span></button>
